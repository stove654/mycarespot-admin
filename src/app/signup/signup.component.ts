...
export class SignupComponent implements OnInit {
	...
	signup () {
		...
		data.phone = '+' + data.selectedValue + data.phone;
		data.countryCode = '+' + data.selectedValue;
		this.isLoading = true;
